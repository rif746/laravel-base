...
Copy and paste the block below into your AI agent's chat or system instructions **before** asking it to write or refactor code in this repository. This ensures the agent understands and adheres to all Antigravity architectural constraints.
