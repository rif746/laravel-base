...
use App\UI\Support\Scramble\MessageResourceExtension;
use App\UI\Support\Scramble\SuccessResourceExtension;
...
return [
    ...
    'extensions' => [
        SuccessResourceExtension::class,
        MessageResourceExtension::class
    ],
