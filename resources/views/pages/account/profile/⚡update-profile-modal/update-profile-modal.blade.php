<x-modal id="update-profile-modal" :title="$this->title" wire:submit="save" wire:loading form livewire>
    ...
    <x-form.input name="date_of_birth" type="date" :label="__('domains/account.fields.profile.date_of_birth')"
                  wire:model="date_of_birth"/>
    <x-form.input name="phone_number" type="number" :label="__('domains/account.fields.profile.phone_number')"
