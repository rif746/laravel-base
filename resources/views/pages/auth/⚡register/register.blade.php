<div>
    <form class="needs-validation mt-3" wire:submit="register" novalidate>
        ...
        <x-form.input name="form.name" :label="__('domains/auth.fields.register.name')" wire:model.blur="form.name" type="text" :placeholder="__('domains/auth.fields.register.name')" required
        ...
        <x-form.input name="form.password" :label="__('domains/auth.fields.register.password')" wire:model.blur="form.password" type="password"
            :placeholder="__('domains/auth.fields.register.password')" required autocomplete="new-password" />
        ...
        <x-form.input name="form.password_confirmation" :label="__('domains/auth.fields.register.confirm_password')" wire:model.blur="form.password_confirmation"
            type="password" :placeholder="__('domains/auth.fields.register.confirm_password')" required autocomplete="new-password" />
