<div>
    <form class="needs-validation d-flex flex-column mt-3 gap-3" wire:submit="register" novalidate>
        <x-form.input
            name="form.name"
    ...
    <div class="small text-muted mt-3 text-center">
        ...
        <x-link href="{{ route('login') }}" :label="__('domains/auth/pages.register.login_link')" theme="primary" />
    </div>
</div>
