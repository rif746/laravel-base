<div>
    ...
    <form wire:submit="confirmPassword" class="needs-validation mt-3" novalidate>
        ...
        <x-form.input name="form.password" wire:model="form.password" :label="__('domains/auth.fields.confirm_password.password')" type="password" :placeholder="__('domains/auth.fields.confirm_password.password')"
