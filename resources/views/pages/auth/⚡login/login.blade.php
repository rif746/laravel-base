<div class="vh-100 d-flex flex-column align-items-center justify-content-center p-3 overflow-hidden">
    <div class="card border border-2 border-body-tertiary shadow-sm rounded-4 w-100 overflow-hidden" style="max-width: 420px;">
        <div class="card-body p-4 p-sm-5 text-center d-flex flex-column gap-3 justify-content-center align-items-center">
            ...
            <!-- Header Brand & Auth Badge (Logo | Login Icon) -->
            <div class="d-inline-flex align-items-center justify-content-center gap-3 bg-body-tertiary border border-body-tertiary px-3 py-2 rounded-pill">
                ...
                <div class="text-primary d-inline-flex align-items-center justify-content-center">
                    <x-tabler-login-2 width="26" height="26" stroke-width="1.75" />
                </div>
            </div>
            ...
            <div class="w-100 text-start">
                ...
                <div class="text-center mb-3">
                    ...
                    <p class="text-body-secondary small mb-0">
                        {{ __('domains/auth/pages.login.welcome_subtitle') }}
                    </p>
                </div>
                ...
                <!-- Login Form -->
                <form class="needs-validation d-flex flex-column gap-3" wire:submit="login" novalidate>
                    <!-- Email Input -->
                    <x-form.input
                        name="form.email"
                        wire:model="form.email"
                        :label="__('domains/auth/field.login.email')"
                        type="email"
                    ...
                    <x-form.input
                        ...
                        type="password"
                        :placeholder="__('domains/auth/field.login.password')"
                        :label="__('domains/auth/field.login.password')"
                        required
                        minlength="6"
                    />
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <x-form.checkbox
                            ...
                            :label="__('domains/auth/field.login.remember')"
                        />
                        <x-link
                            :href="route('password.request')"
                            :label="__('domains/auth/field.login.forgot_password')"
                            theme="primary"
                        />
                    </div>
                    ...
                    <x-button
                        ...
                        theme="primary"
                        :label="__('domains/auth/field.login.submit')"
                ...
                <div class="fs-7 text-body-secondary mt-4 text-center">
                    ...
                    <x-link :href="route('register')" :label="__('domains/auth/pages.login.register_link')" theme="primary" class="fw-semibold text-decoration-none" />
                </div>
            </div>
