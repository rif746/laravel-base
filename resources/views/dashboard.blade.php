    ...
    <div class="container-fluid">
        ...
        <div class="row g-3 mb-3">
            <div class="col-lg-3 col-12">
                ...
                <div class="card bg-primary border-primary rounded-2 border border-opacity-25 bg-opacity-10 p-4">
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <div>
                            <h2 class="fs-6 mb-3">Total Sales</h2>
                            <h3 class="fw-bold mb-0">$25,000</h3>
                            <p class="text-primary small mb-0">+5% since last month</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-12">
                ...
                <div class="card bg-success border-success rounded-2 border border-opacity-25 bg-opacity-10 p-4">

                    <div class="d-flex gap-3">
                        <div class="icon-shape icon-md bg-success rounded-2 text-white">
                            <i class="ti ti-repeat fs-4"></i>
                        </div>
                        <div>
                            <h2 class="fs-6 mb-3">Total Purchase</h2>
                            <h3 class="fw-bold mb-0">$18,000</h3>
                            <p class="text-success small mb-0">+22% since last month</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-12">
                ...
                <div class="card bg-info border-info rounded-2 border border-opacity-25 bg-opacity-10 p-4">
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <div>
                            <h2 class="fs-6 mb-3">Total Expenses</h2>
                            <h3 class="fw-bold mb-0">$9,000</h3>
                            <p class="text-info small mb-0">+10% since last month</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-12">
                ...
                <div class="card bg-warning border-warning rounded-2 border border-opacity-25 bg-opacity-10 p-4">
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <div>
                            <h2 class="fs-6 mb-3">Invoice Due</h2>
                            <h3 class="fw-bold mb-0">$25,000</h3>
                            <p class="text-warning small mb-0">+35% since last month</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-12">
                <div class="card">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between border-bottom mb-3 pb-5">
                            <div>
            ...
            <div class="col-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row border-top mt-4 pt-4 text-center">
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-4">
                <div class="card h-100">
                    <div class="card-header d-flex justify-content-between align-items-center bg-white px-4 py-3">
                        <h4 class="h5 mb-0">Top Selling Products</h4>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex align-items-center gap-3">
                            ...
                            <span class="badge bg-danger-subtle text-danger border-danger border">18%</span>
                        </li>
                        ...
                        <li class="list-group-item d-flex align-items-center gap-3">
                            ...
                            <span class="badge bg-primary-subtle text-primary border-primary border">32%</span>
                        </li>
                        ...
                        <li class="list-group-item d-flex align-items-center gap-3">
                            ...
                            <span class="badge bg-info-subtle text-info border-info border">22%</span>
                        </li>
                        <li class="list-group-item d-flex align-items-center gap-3">
                            ...
                            <span class="badge bg-success-subtle text-success border-success border">28%</span>
                        </li>
                        <li class="list-group-item d-flex align-items-center gap-3">
                            ...
                            <span class="badge bg-warning-subtle text-warning border-warning border">25%</span>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="card h-100">
                    <div class="card-header d-flex justify-content-between align-items-center bg-white px-4 py-3">
                        <div class="d-flex align-items-center">
                            ...
                            <h4 class="h5 mb-0">Low Stock Products</h4>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="card h-100">
                    <div class="card-header d-flex justify-content-between align-items-center bg-white px-4 py-3">
                        <h4 class="h5 mb-0">Recent Sales</h4>
                        <button class="btn btn-sm btn-outline-secondary">
